...
public class Squares {
    ...
    /**
     * Main game loop. It creates random squares which RAIN FROM THE
     * MOTHER-EFFING SKY. These squares are also IN OUTER SPACE.
     */
    public void run() {
        // UI layers
    ...
    VBox buttonBar = new VBox();
        ...
        // Set up UI
            ...
            .addAll(bg, planets, ships, buttonBar);
            bg.getChildren ()
